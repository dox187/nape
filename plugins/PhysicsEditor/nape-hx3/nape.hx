...
typedef PhysBodyType = { body:Body, anchor:Vec2 };
...
class PhysicsData {
    ...
    public static function registerFilter(name:String,filter:InteractionFilter) {
        if(filters==null) filters = new Map<String,InteractionFilter>();
    ...
    public static function registerFluidProperties(name:String,properties:FluidProperties) {
        if(fprops==null) fprops = new Map<String,FluidProperties>();
    ...
    public static function registerCbType(name:String,cbType:CbType) {
        if(types==null) types = new Map<String,CbType>();
        types.set(name,cbType);
    }

    //----------------------------------------------------------------------

    static var bodies   :Map<String,PhysBodyType>;
    static var materials:Map<String,Material>;
    static var filters  :Map<String,InteractionFilter>;
    static var fprops   :Map<String,FluidProperties>;
    static var types    :Map<String,CbType>;
